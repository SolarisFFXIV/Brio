...
public class BoneFilter
{
    ...
    {
        _allowedCategories.Clear();
        _allowedCategories.Add("head");
        _allowedCategories.Add("body");
        _allowedCategories.Add("handsRight");
        _allowedCategories.Add("handsLeft");
        _allowedCategories.Add("legsLeft");
        _allowedCategories.Add("legsRight");
        _allowedCategories.Add("tail");
