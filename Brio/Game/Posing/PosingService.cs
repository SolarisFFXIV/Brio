...
public class PosingService
{
    ...
    public bool ShowBonesForAllVisibleActors { get; set; } = false;
    ...
    public PosingService()
    {
        ...
        // Enable only the main body parts: Head, Body, Right Arm, Left Arm, Legs, Tail
        OverlayFilter.EnableCategory("head");
        OverlayFilter.EnableCategory("body");
        OverlayFilter.EnableCategory("handsRight");
        OverlayFilter.EnableCategory("handsLeft");
        OverlayFilter.EnableCategory("legsLeft");
        OverlayFilter.EnableCategory("legsRight");
        OverlayFilter.EnableCategory("tail");
    ...
    /// <summary>
    /// Gets the bone category ID for a given bone name
    /// </summary>
    public string? GetBoneCategoryId(string boneName)
    {
        foreach(var category in BoneCategories.Categories)
        {
